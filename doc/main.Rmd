...
####• Data Processing: Devide data into training set(1200 observations) and test set(300 obervations) 
...
####• Result: as following codes weill show 
```{r,warning=F}
...
### Part a: Using R to clean news data
####• Data source: Bloomberg and WSJ 
...
####• Data Processing: Using R, and you can find the code at lib/features_matching.R
...
####• Data Processing: Scraping news and earnings from Bloomberg and WSJ, extracting features using NLP and we do model evalution 
####• Result: As follows
```{r}
