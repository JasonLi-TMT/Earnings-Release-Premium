...
### Part a: NLP 
####• Data source: Bloomberg and WSJ news headlines, stored in a csv file (news_Bloomberg.csv)
...
####• Data Processing: Extracting features using NLP. Specifically, we use R built-in pacakge "syuzhetand" and word_count method. 
####• Result: As follows
```{r}
# source("../lib/sentimental.r")
```

### Part b: Used R to match and clean news data
