load('fin_feature1.Rdata')
load('fin_feature2.Rdata')
load('fin_feature3.Rdata')
load('fin_feature4.Rdata')
...
# save(earning.sub, mom, dy, ebitg, ev2ebitda, file = 'fin_feature1.Rdata')
# save(m2b, pb, file = 'fin_feature2.Rdata')
# save(pe, pf, file = 'fin_feature3.Rdata')
# save(ps, price, file = 'fin_feature4.Rdata')
...
# write.csv(all.df, 'all_features.csv')
